...
if __name__ == '__main__':
    ...
    Note: This py is implemented by 1 single thread which will be slow. Use example_pcap2csv_multi_process.py to get better performance.
    """
    ...
    while True:
        ...
        print(f'{time.time()}: Extract 1 chunk. {len(samples)} hosts detected.')
